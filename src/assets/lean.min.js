  ...
  var e = (() => {
    ...
    return e(e => {
      var a = {
          $pattern: /\w+|\u03bb|\u2200|\u03a0|\u2203|:=?/u,
          keyword:
            'theorem|10 lemma|10 definition def class structure instance example inductive coinductive axiom axioms hypothesis constant constants universe universes variable variables parameter parameters begin end infix infixr import open theory prelude renaming hiding exposing calc  match do  by let in extends fun assume #check #eval #reduce #print \u03bb \u2200 \u2203 \u2a01 \u03a0',
          built_in:
        ...
        t = {
          ...
          contains: [
            ...
            { className: 'symbol', begin: /:=/, endsParent: !0 },
            { className: 'symbol', begin: /:/, endsParent: !0 }
          ],
          keywords: a
        }
